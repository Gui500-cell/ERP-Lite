...
Passos
Entrar em Supabase.com (criar conta se necessário)

Acesse Supabase.com e faça login com sua conta existente ou crie uma nova conta se necessário.
Criar novo projeto em Supabase (conectar com Github e habilitar RLS)
...
Guardar URL do projeto e Anon Key para uso posterior
...
Instalar Supabase na aplicação: @supabase/supabase-js
...
Na raiz do projeto, criar arquivo '.env' com este conteúdo
...
Na pasta main, criar a pasta services e dentro desta criar o arquivo supabase.ts
...
No arquivo supabase.ts, colocar o seguinte código
...
Criar o arquivo src/main/services/auth.ts
